...
```bash
python3 .cursor/skills/ui-ux-pro-max/scripts/search.py "<keyword>" --stack <your-stack>
...
```bash
python3 .cursor/skills/ui-ux-pro-max/scripts/search.py "list performance navigation" --stack nextjs
```
