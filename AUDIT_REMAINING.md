...
> **تحقّق إضافي (مستودع الكود، 2026-07-25):** كل ما ورد بهذا الملف لا يزال صحيحاً ✓ — تصحيح `debit_base_base` مؤكَّد (صفر نتائج بالمستودع)، وكل صفوف جدول الحالة بالقسم 2 لا تزال مطابقة للكود الحالي بلا أي انحراف. البنود "خارج النطاق" بالقسم 3 غُطّيت لاحقاً بتقارير `audit-reports/2026-07-22-accounts-vouchers-audit.md`، `2026-07-22-materials-warehouses-audit.md`، و`2026-07-23-invoices-audit.md`.
