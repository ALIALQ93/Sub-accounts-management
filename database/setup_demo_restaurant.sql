...
--     → محضّرات مخزّنة R-PATTY / R-LAMB-SEAS / R-CHICK-MAR  (semi = نصف مصنّع للمرحلة التالية)
...
drop function if exists public.is_invoice_cancelling() cascade;
drop function if exists public.assert_invoice_may_post(uuid) cascade;
drop function if exists public.cancel_draft_invoice(uuid) cascade;
drop function if exists public.list_reference_returned_quantities(uuid, uuid) cascade;
...
begin
  ...
  if new.quantity_base_delta > 0
    ...
    -- مرتجع مبيعات: كمية داخلة لكن التكلفة بعكس تكلفة الإخراج (مثل القيد)
    if v_kind = 'return_sale' then
...
-- =============================================================================
-- BEGIN patch_materials_warehouses_audit_fix.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_invoice_material_require_base_unit.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_invoices_audit_fix.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_pos_audit_fixes.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_materials_bom_nested.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_invoice_manufacturing.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_composite_disassembly.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_inventory_cost_policy.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_reports_audit_fix.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_reports_audit_fix2.sql
-- =============================================================================
-- =============================================================================
...
-- =============================================================================
-- BEGIN patch_schema_setup_status.sql
-- =============================================================================
-- =============================================================================
...
-- تطبيق قالب مبسّط + أنماط الفواتير الأساسية لبيئة العرض
select public.apply_coa_template('simplified', 'commercial');
...
begin
  ...
  if not exists (select 1 from public.materials where material_code = 'R-PATTY') then
    insert into public.materials (
      ...
      'composite', 'semi',
      'نصف مصنّع مرحلة 1: لحم ني + توابل → قرص جاهز للشوي/التجميع'
    ) returning id into v_mat;
    insert into public.material_units (
      material_id, unit_code, name_ar, is_base_unit, factor_to_base,
      conversion_op, conversion_factor, sort_order
  ...
  if not exists (select 1 from public.materials where material_code = 'R-LAMB-SEAS') then
    insert into public.materials (
      ...
      'composite', 'semi',
      'نصف مصنّع مرحلة 1: لحم ني متبّل — يُستخدم لاحقاً كمدخل للمنسف/المشاوي'
    ) returning id into v_mat;
    insert into public.material_units (
      material_id, unit_code, name_ar, is_base_unit, factor_to_base,
      conversion_op, conversion_factor, sort_order
  ...
  if not exists (select 1 from public.materials where material_code = 'R-CHICK-MAR') then
    insert into public.materials (
      ...
      'composite', 'semi',
      'نصف مصنّع مرحلة 1: دجاج ني متبّل — مدخل لأطباق الدجاج/المشاوي'
    ) returning id into v_mat;
    insert into public.material_units (
      material_id, unit_code, name_ar, is_base_unit, factor_to_base,
      conversion_op, conversion_factor, sort_order
